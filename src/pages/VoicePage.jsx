...
const letters = [
  ...
  },
  {
    ...
    title: '大変よくして下さいます。',
    text: '大変よくして下さるので、今まで通りでよいと思っています。ありがとうございます',
    author: '80代男性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
  {
    id: 5,
    image: '/voices/letter-5.jpg',
    title: '何もかも忘れていい気持ちです。',
    text: '外出できない者にとって、家にいながらマッサージを受けられる訪問マッサージは、きめられた時間に家に来て下さり、マッサージをしてもらっている間にいろいろな事がきけるし、マッサージをしてもらっている間、何もかも忘れていい気持ちです。',
    author: '80代女性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
  {
    id: 6,
    image: '/voices/letter-6.jpg',
    title: '満足しています。',
    text: 'マナーもよく、訪問時間も正確で満足しています。',
    author: '80代女性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
  {
    id: 7,
    image: '/voices/letter-7.jpg',
    title: '続けてお願いしたい。',
    text: 'マッサージ後、身体が軽く感じられる、よく眠れる、との事。続けてお願いしたいと思います。',
    author: '80代男性',
    relation: 'ご家族(奥様)より',
    area: '岡山市中区',
  },
  {
    id: 8,
    image: '/voices/letter-8.jpg',
    title: '先生との会話が楽しみです。',
    text: '凝っているところを集中してマッサージしてくださって、とても気持ちが良いです。気さくな先生で、先生との会話が楽しみです。',
    author: '80代女性',
    relation: 'ご本人より',
    area: '岡山市中区',
  },
  {
    id: 9,
    image: '/voices/letter-9.jpg',
    title: '今までどおりで。',
    text: '今まで通りでよろしいです。よろしくお願いいたします。',
    author: '80代女性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
  {
    id: 10,
    image: '/voices/letter-10.jpg',
    title: '頼みいいです。',
    text: 'こちらの都合にあわせて下さるので、頼みいいです。今後共よろしくお願い致します。足の裏がわを入れていただけないか。(※補足 こちらの方は、リラクゼーション的な足裏マッサージも希望されておられました。)',
    author: '70代女性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
  {
    id: 11,
    image: '/voices/letter-11.jpg',
    title: 'もう15分延長してください。',
    text: '私個人の要望ですが、もう１５分延長出来れば幸いです。(※補足 時間的な都合により難しい時もありますが、出来るだけご希望に応えたいと思っております。)',
    author: '70代女性',
    relation: 'ご家族(ご主人様)より',
    area: '岡山市北区',
  },
  {
    id: 12,
    image: '/voices/letter-12.jpg',
    title: '研究してください。',
    text: '失語症と仲良くするテクニックを研究して下さい。(※補足 脳梗塞後遺症による失語症がある方に対して、これから考えていかなければならない事だと思います。)',
    author: '70代男性',
    relation: 'ご本人より',
    area: '岡山市中区',
  },
  {
    id: 13,
    image: '/voices/letter-13.jpg',
    title: '喜んでいます。',
    text: '動かないので疲れがたまり、肩こりから頭痛を起こしていたが、定期的にマッサージしてもらうことにより少なくなり、喜んでいる。',
    author: '80代女性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
  {
    id: 14,
    image: '/voices/letter-14.jpg',
    title: 'リラックス出来ます。',
    text: '左半身マヒでリハビリを受けています。リハビリのみでは筋肉の痛み、疲れがとれないため、マッサージを受けています。マッサージを受けることにより、堅くなった筋肉の緊張がほぶれ、リラックス出来ます。マッサージでマヒを直すことは困難とは思いますが、リハビリ等との併用により効果が現れると自分では考えています。そのため、マッサージ師の方には自分の希望を伝え、その箇所を重点にマッサージしてもらうこともあります。',
    author: '70代男性',
    relation: 'ご本人より',
    area: '岡山市北区',
  },
